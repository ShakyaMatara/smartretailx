...
def dynamodb_resource():
    ...
    endpoint_url points at LocalStack locally. Removing that single
    argument makes this identical to production AWS code - the SDK
    calls, table definitions and queries are unchanged.
    """
